...
def get_base_folder(index):
    if index == 0:
        return "datasets/fitd_bss_qwen3n_vs_circuitbreaker__async_batch_bagel_eval_3repl"
    elif index == 1:
        return "datasets/fitd_bss_qwen3n_vs_dertains__async_batch_bagel_eval_3repl"
    elif index == 2:
        return "datasets/fitd_bss_qwen3n_vs_door__async_batch_bagel_eval_3repl"
    elif index == 3:
        return "datasets/fitd_bss_qwen3n_vs_guardr__async_batch_bagel_eval_3repl"
    elif index == 4:
        return "datasets/fitd_bss_qwen3n_vs_llamainstruct__async_batch_bagel_eval_3repl"
    elif index == 5:
        return "datasets/fitd_bss_qwen3n_vs_cbllama__async_batch_bagel_eval_3repl"
    elif index == 6:
        return "datasets/fitd_bss_qwen3n_vs_guardq__async_batch_bagel_eval_3repl"
    elif index == 7:
        return "datasets/fitd_bss_qwen3n_vs_nemor__async_batch_bagel_eval_3repl"
    elif index == 8:
        return "datasets/fitd_bss_qwen3n_vs_nemoq__async_batch_bagel_eval_3repl"
    else:
...
async def run_one(row, agent_index=0, i=0):
    ...
    with MessageFileLogger(
        output_folder_name=f"{base_folder}/fitd_bss_{row['id']}{suff}", buffer_max_size=20
    ) as logger:
        ...
        with open(f"{base_folder}/fitd_bss_{row['id']}{suff}/info.txt", "w+") as f:

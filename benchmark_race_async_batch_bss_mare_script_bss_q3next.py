...
VLLM_HOST_BAGEL = "dgxa100-ncit-wn04.grid.pub.ro"
VLLM_HOST_QWEN = "dgxa100-ncit-wn04.grid.pub.ro"


def get_base_folder(index):
    if index == 0:
        return "datasets/race_bss_qwen3n_vs_circuitbreaker__async_batch_bagel_eval_3repl_powerful"
    elif index == 1:
        return "datasets/race_bss_qwen3n_vs_dertains__async_batch_bagel_eval_3repl_powerful"
    elif index == 2:
        return "datasets/race_bss_qwen3n_vs_door__async_batch_bagel_eval_3repl_powerful"
    elif index == 3:
        return "datasets/race_bss_qwen3n_vs_guardr__async_batch_bagel_eval_3repl_powerful"
    elif index == 4:
        return "datasets/race_bss_qwen3n_vs_llamainstruct__async_batch_bagel_eval_3repl_powerful"
    elif index == 5:
        return "datasets/race_bss_qwen3n_vs_cbllama__async_batch_bagel_eval_3repl_powerful"
    elif index == 6:
        return "datasets/race_bss_qwen3n_vs_guardq__async_batch_bagel_eval_3repl_powerful"
    elif index == 7:
        return "datasets/race_bss_qwen3n_vs_nemor__async_batch_bagel_eval_3repl_powerful"
    elif index == 8:
        return "datasets/race_bss_qwen3n_vs_nemoq__async_batch_bagel_eval_3repl_powerful"
    else:
...
async def run_one(row, agent_index=0, i=0):
    ...
    with MessageFileLogger(
        output_folder_name=f"{base_folder}/race_bss_{row['id']}{suff}", buffer_max_size=20
    ) as logger:
        ...
        with open(f"{base_folder}/race_bss_{row['id']}{suff}/info.txt", "w+") as f:

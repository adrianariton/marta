...
# shard save
prepare_and_shard_for_hf(df, output_dir="marta_corrected", num_shards=16)

df_train = pd.read_parquet("train.parquet")
df_train.loc[df_train["dataset"] == "walledai/XSTest", "attacker"] = "Qwen/Qwen2.5-32B-Instruct"
df_train.to_parquet("train_corrected.parquet", index=False)


df_test = pd.read_parquet("test.parquet")
df_test.loc[df_test["dataset"] == "walledai/XSTest", "attacker"] = "Qwen/Qwen2.5-32B-Instruct"
df_test.to_parquet("test_corrected.parquet", index=False)


df_val = pd.read_parquet("val.parquet")
df_val.loc[df_val["dataset"] == "walledai/XSTest", "attacker"] = "Qwen/Qwen2.5-32B-Instruct"
df_val.to_parquet("val_corrected.parquet", index=False)

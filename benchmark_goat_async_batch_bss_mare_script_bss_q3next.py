...
def get_base_folder(index):
    if index == 0:
        return "datasets/goat_bss_qwen3n_vs_circuitbreaker__async_batch_bagel_eval_3repl"
    elif index == 1:
        return "datasets/goat_bss_qwen3n_vs_dertains__async_batch_bagel_eval_3repl"
    elif index == 2:
        return "datasets/goat_bss_qwen3n_vs_door__async_batch_bagel_eval_3repl"
    elif index == 3:
        return "datasets/goat_bss_qwen3n_vs_guardr__async_batch_bagel_eval_3repl"
    elif index == 4:
        return "datasets/goat_bss_qwen3n_vs_llamainstruct__async_batch_bagel_eval_3repl"
    elif index == 5:
        return "datasets/goat_bss_qwen3n_vs_cbllama__async_batch_bagel_eval_3repl"
    elif index == 6:
        return "datasets/goat_bss_qwen3n_vs_guardq__async_batch_bagel_eval_3repl"
    elif index == 7:
        return "datasets/goat_bss_qwen3n_vs_nemor__async_batch_bagel_eval_3repl"
    elif index == 8:
        return "datasets/goat_bss_qwen3n_vs_nemoq__async_batch_bagel_eval_3repl"
...
async def run_one(row, agent_index=0, shared_session=None, i=0):
    ...
    with MessageFileLogger(
        output_folder_name=f"{base_folder}/goat_bss_{row['id']}{suff}", buffer_max_size=20
    ) as logger:
        ...
        with open(f"{base_folder}/goat_bss_{row['id']}{suff}/info.txt", "w+") as f:

...
def get_base_folder(index):
    if index == 0:
        return "datasets/goat_adv_qwen25_vs_circuitbreaker__async_batch_bagel_eval_3repl_r10"
    elif index == 1:
        return "datasets/goat_adv_qwen25_vs_derta__async_batch_bagel_eval_3repl_r10"
    elif index == 2:
        return "datasets/goat_adv_qwen25_vs_door__async_batch_bagel_eval_3repl_r10"
    elif index == 3:
        return "datasets/goat_adv_qwen25_vs_guard__async_batch_bagel_eval_3repl_r10"
    elif index == 4:
        return "datasets/goat_adv_qwen25_vs_llamainstruct__async_batch_bagel_eval_3repl_r10"
    elif index == 5:
        return "datasets/goat_adv_qwen25_vs_cbllama__async_batch_bagel_eval_3repl_r10"
    elif index == 6:
        return "datasets/goat_adv_qwen25_vs_guardresp__async_batch_bagel_eval_3repl_r10"
    else:

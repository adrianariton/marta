...
def get_base_folder(index):
    if index == 0:
        return (
            "datasets/race_xstest_qwen25_vs_circuitbreaker__async_batch_bagel_eval_3repl_powerful"
        )
    elif index == 1:
        return "datasets/race_xstest_qwen25_vs_derta__async_batch_bagel_eval_3repl_powerful"
    elif index == 2:
        return "datasets/race_xstest_qwen25_vs_door__async_batch_bagel_eval_3repl_powerful"
    elif index == 3:
        return "datasets/race_xstest_qwen25_vs_guardllama__async_batch_bagel_eval_3repl_powerful"
    elif index == 4:
        return "datasets/race_xstest_qwen25_vs_llamainstruct__async_batch_bagel_eval_3repl_powerful"
    elif index == 5:
        return "datasets/race_xstest_qwen25_vs_cbllama__async_batch_bagel_eval_3repl_powerful"
    else:
...
async def run_all(safety_df, max_concurrent: int = 5, _agent_index=0):
    ...
    batches_per_index = [batch, batch1, batch2, batch3, batch4, batch5]
    all_tasks = []
    for agent_index in [1, 2, 3, 4, 5]:

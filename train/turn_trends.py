...
plt.savefig(
    "marta_graphs/damping_resistance_boxplots.png",
    dpi=200,
    bbox_inches="tight"
)
...
plt.savefig(
    "marta_graphs/damping_resistance_boxplots_erosion.png",
    dpi=200,
    bbox_inches="tight"
)
...
plt.savefig(
    "marta_graphs/damping_resistance_boxplots_erosion_byatk.png",
    dpi=200,
    bbox_inches="tight"
)
...
plt.savefig(
    "marta_graphs/damping_resistance_heatmap.png",
    dpi=200,
    bbox_inches="tight"
)

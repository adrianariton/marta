...
class A_Crescendo(Attack):
    def get_base_folder(self, index):
        if index == 9:
            return "datasets/crescendo_orbench_qwen3n_vs_cbadimixed2000__async_batch_bagel_eval_3repl_3x8x5"

        elif index == 5:
            return "datasets/crescendo_orbench_qwen3n_vs_cbllama__async_batch_bagel_eval_3repl_3x8x5"

    def get_subfolder(self, index):
        return "crescendo_orbench_" + index
...
df = OrBench().sample_randomly(n=200, random_state=42)

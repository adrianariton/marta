...
safety_df = AdvBench().sample_randomly(30)
...
def get_base_folder(index):
    if index == 0:
        return (
            "datasets/race_adv_qwen25_vs_circuitbreaker__async_batch_bagel_eval_3repl_powerful_r10"
        )
    elif index == 1:
        return "datasets/race_adv_qwen25_vs_derta__async_batch_bagel_eval_3repl_powerful_r10"
    elif index == 2:
        return "datasets/race_adv_qwen25_vs_door__async_batch_bagel_eval_3repl_powerful_r10"
    elif index == 3:
        return "datasets/race_adv_qwen25_vs_guardllama__async_batch_bagel_eval_3repl_powerful_r10"
    elif index == 4:
        return (
            "datasets/race_adv_qwen25_vs_llamainstruct__async_batch_bagel_eval_3repl_powerful_r10"
        )
    elif index == 5:
        return "datasets/race_adv_qwen25_vs_cbllama__async_batch_bagel_eval_3repl_powerful_r10"
    else:

...
def analyze_goal_revealed_agreement(
    file1_path, file2_path, output_dir, judge1_name="Judge1", judge2_name="Judge2", args=None
):
    ...
    metrics1 = judge_metrics(human1, ai1)
    metrics2 = judge_metrics(human2, ai2)
    consensus_mask = human1 == human2
    human_consensus = human1[consensus_mask]
    ai_consensus = ai1[consensus_mask]  # or ai2, they should be the same
...
results = analyze_goal_revealed_agreement(
    args.file1, args.file2, output_dir, args.judge1, args.judge2, args
)
